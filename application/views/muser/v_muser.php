            ...
            <div class="card">
              <div class="card-header border-0">
                <div class="float-left">
                  ...
                  <button type="button" class="btn btn-primary btn-flat" name="button" onclick="add_data()"><i class="fa fa-plus"></i> Tambah</button>
                </div>
              </div>
              <div class="card-body">
...
<?php $this->load->view('muser/m_muser') ?>
</div>
<?php $this->load->view('_partials/js') ?>
<?php $this->load->view('muser/js_muser') ?>
</body>
</html>
